...
МАҢЫЗДЫ: Егер анализдің кез-келген бөлімі бойынша ақпарат жеткіліксіз болса, ол бөлім үшін null емес, "Ақпарат жеткіліксіз" деген мәтінді қайтарыңыз.
...
ВАЖНО: Если для какой-либо секции анализа недостаточно информации, вместо null верни строку "Недостаточно информации".
